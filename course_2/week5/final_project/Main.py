...
pygame.display.set_caption("SuperDuperRPG")
...
def create_game(sprite_size, is_new):
    ...
    if is_new:
        ...
        drawer = ScreenEngine.GameSurface((640, 480), pygame.SRCALPHA, (0, 480),
                                ScreenEngine.ProgressBar((640, 120), (640, 160),
                                                ScreenEngine.InfoWindow((160, 440), (640, 0),
                                                        ScreenEngine.MiniMap((160, 160), (50, 50),
